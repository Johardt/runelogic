                  ...
                  return (
                    <div key={char.characterId} className="relative">
                      ...
                      <label
                        ...
                        className="block cursor-pointer rounded-xl border-2 border-transparent peer-checked:border-primary peer-checked:bg-primary/10 hover:bg-gray-100 transition-colors p-0"
